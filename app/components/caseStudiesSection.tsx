...
const CASE_STUDY_COVER_IMAGES = [
  "/colorful-ecommerce-store-kids-toys.jpg",
  "/professional-b2b-shopify-dashboard-with-hubspot-cr.jpg",
  "/digital-marketing.png",
  "/shopify-inventory-management-dashboard-with-automa.jpg",
  "/casestudy5.png",
];
            ...
            {caseStudies.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="flex max-h-[70vh] flex-col gap-2.5 overflow-y-auto text-left [scrollbar-width:thin]">
                      <div className="relative aspect-video w-full shrink-0 overflow-hidden rounded-lg bg-[#1a1d4a]">
                      ...
                      <div className="rounded-lg border border-red-500/25 bg-red-500/10 p-2">
                        <p className="line-clamp-3 text-[11px] leading-relaxed text-white/95 sm:text-xs">
                      ...
                      <div className="rounded-lg border border-green-500/25 bg-green-500/10 p-2">
                        <strong className="text-[11px] text-green-400 sm:text-xs">Results:</strong>
                        <ul className="mt-1 list-inside list-disc space-y-0.5 text-[11px] leading-relaxed text-white/95 sm:text-xs">
